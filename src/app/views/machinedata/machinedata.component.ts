...
// } else {
//   selectedArray.length = 0;
//   selectedArray.push(...options.map(opt => opt.ProjectId || opt.key || opt));
// }
...
//   // Clear lower levels if parent is deselected
//   if (key === 'project' && selectedArray.length === 0) {
//     this.selectedZones = [];
//     this.selectedWards = [];
//     this.selectedSubZones = [];
//     this.selectedWardList = [];
...
//   if (key === 'state' && selectedArray.length === 0) {
//     this.selectedWards = [];
//     this.selectedSubZones = [];
//     this.selectedWardList = [];
//     this.selectedBeatList = [];
...
//   if (key === 'district' && selectedArray.length === 0) {
//     this.selectedSubZones = [];
//     this.selectedWardList = [];
//     this.selectedBeatList = [];
//     this.selectedBeats = [];
...
//   if (key === 'zone' && selectedArray.length === 0) {
//     this.selectedWardList = [];
//     this.selectedBeatList = [];
//     this.selectedBeats = [];
//   }

//   if (key === 'ward' && selectedArray.length === 0) {
//     this.selectedBeatList = [];
//     this.selectedBeats = [];
//   }
...
// console.log("State:", [...this.hierarchySelection.state]);
// console.log("District:", [...this.hierarchySelection.district]);
// console.log("Zone:", [...this.hierarchySelection.zone]);
// console.log("Ward:", [...this.hierarchySelection.ward]);
// console.log("Beat:", [...this.hierarchySelection.beat]);
                    ...
                    wardobj.beats.forEach((beatobj: any) => {
                      if (this.selectedBeatList.includes(beatobj.beat)) {
                        if (beatobj.machines && Array.isArray(beatobj.machines)) {
                          console.log(`Adding machines from beat ${beatobj.beat}:`, beatobj.machines);
                          this.beats.push(...beatobj.machines);
                        } else {
                          console.warn(`Beat ${beatobj.beat} has no machines or machines is not an array`);
                        }
                      }
                    });
                  }
