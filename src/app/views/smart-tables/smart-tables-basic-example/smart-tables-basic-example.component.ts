...
//     const selectedBeats = this.commonDataService.userDetails?.clientId 
//     ? [this.commonDataService.userDetails.clientId.toString()] 
//     : [];
//     const selectedProjectId = this.commonDataService.userDetails?.clientId 
//     ? [this.commonDataService.userDetails.clientId.toString()] 
//     : [];
...
//     this.dataService.getMachineAndIncineratorTransaction(
//         this.startDate, this.endDate, this.merchantId, selectedMachines,
//         selectedZones, selectedWards, selectedBeats
//     ).subscribe(
//         (response: any) => {
//             console.log("✅ API Response Received:", response);
//             if (response.code === 200 && response.data?.machineDetails) {
